        ...
        return Stack(
          ...
          children: [
            ...
            Positioned(
              bottom: -60.h,
              left: 5.w,
              child: SmallPoster(movieId: snapshot.data?.results?[pro.selectedMovie].id, posterPath: '$IMAGE_BASE_URL${snapshot.data?.results?[pro
                  .selectedMovie].posterPath}', voteCount: '${snapshot.data?.results?[pro.selectedMovie]
                  .voteAverage}'),
